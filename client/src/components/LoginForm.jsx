...
{
  return <article className="m-4 flex flex-col items-center content-center">
    <section className="flex flex-col bg-palette-c-mid h-full">
      ...
      <div className="flex flex-col m-4 p-4">
        ...
        <input className="bg-palette-c-dark rounded-md" name="email" type="email"/>
        <div className="m-2"/>
        <label className="ml-4" htmlFor="password">Password:</label>
        <input className="bg-palette-c-dark rounded-md" name="password" type="password"/>
      </div>
    ...
    <aside className="bg-palette-c-darker">
