...
export default function CardArticle({
  ...
  return (
    <article className={`flex ${flexClass} my-16 gap-12 justify-center items-center mx-auto max-w-xs md:max-w-screen-sm lg:max-w-screen-md`}>
      <section className="w-8/12">
        <p>{description}</p>
      </section>
      <section className="relative w-4/12">
        <a href={link}>
          <img src={image} alt="Card image" className="object-cover h-full w-full"/>
